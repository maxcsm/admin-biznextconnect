...
@Component({
  selector: 'app-customers-pro',
  templateUrl: './customers-pro.page.html',
  styleUrls: ['./customers-pro.page.scss'],
})
export class CustomersProPage implements OnInit {
...
async delete(event: any, item: { id: number; }) {
    ...
    async newuser() {
      this.router.navigateByUrl('/register-pro');
      }
